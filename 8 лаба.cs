...
//    private double Count_sum(string[] words)
//    {
//        double s = 0;
//        foreach (string word1 in words)
//        {
//            string word = word1;
//            if (!char.IsLetter(word[word.Length - 1]) && !char.IsDigit(word[word.Length - 1]))
//            {
//                word = word.Substring(0, word.Length - 1);
//            }
//            if (word.Contains("-") && word.Contains("."))
//            {
//                string new_word = word[1..];
//                string int_p = new_word[0..new_word.IndexOf(".")];
//                string double_p = new_word[(new_word.IndexOf(".") + 1)..];
//                if (double.TryParse(int_p, out double number1) && double.TryParse(double_p, out double number2))
//                {

//                    s += -1 * (number1 + (number2 / (Math.Pow(10, double_p.Length))));
//                }
//            }
//            else if (word.Contains("-"))
//            {
//                string new_word = word[1..];
//                if (double.TryParse(new_word, out double number0))
//                {
//                    s += (-1 * number0);
//                }
//            }
//            else if (word.Contains("."))
//            {
//                string int_part = word[0..word.IndexOf(".")];
//                string double_part = word[(word.IndexOf(".") + 1)..];
//                if (double.TryParse(int_part, out double number1) && double.TryParse(double_part, out double number2))
//                {
//                    s += number1 + (number2 / (Math.Pow(10, double_part.Length)));
//                }
//            }
...
//        Task_15 task15 = new Task_15("посчитай 1 и 2 и еще 100 и даже 52 и еще -1.5 и 60.55!");
